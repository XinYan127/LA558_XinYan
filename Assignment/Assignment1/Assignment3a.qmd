...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" description="" mimeType="" url="file://\\DGRLGM71\C$\Essential GIS\Data\Iowa-Statewide data\Counties" size="" type="Local Area Network" format=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minx="202073.80872299999464303" miny="4470598.39718599990010262" maxz="0" minz="0" dimensions="2" maxx="736849.21039300004485995" maxy="4822673.78653900045901537" crs="EPSG:4326"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
